...
FollowerService.create = (id, followed_id) => {
    return db.one('INSERT INTO followers (person_following_id, person_being_followed_id) VALUES (person_following_id=${id}, person_being_followed_id=${followed_id})', { id, followed_id })
};
