...
(
  ...
  INSERT INTO users
    (email, auth_token)
  VALUES
    ('Dany@westeros.gov', 'kdfl,88');

  INSERT INTO users
    (email, auth_token)
  VALUES
    ('Homer_Simpson@SNPP.com', 'lkjh879');

  INSERT INTO users
    (email, auth_token)
  VALUES
    ('bean@dreamland.gov', 'asdf123');

  INSERT INTO posts
    (author_id, caption)
  VALUES
    (3, 'Who wants to get some drinks!!');

  INSERT INTO comments
    (post_id, author_id, content_text)
  VALUES
    (1, 2, 'Woohoo!!!');
